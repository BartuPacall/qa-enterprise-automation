...
#### Daha sonra tarayıcınızdan http://localhost:8080/ ‘e gidiniz. Daha sonrasında karşınıza gelen ekrandaki kırmızı yazıyla belirtilen dosyayı txt ile açın ve içindeki şifreyi kopyalayıp “Administrator password” kısmına yapıştırın.<br><br>
...
#### Eğer sadece default pluginleri indirmek isterseniz “Install suggested plugins” butonuna basın ve devam edin. Fakat başka pluginler’de indirmek istiyorsanız “Select plugins to install” butonuna basın ve devam edin. İndirme işlemleri sona erince sizden bir user yaratmanız istenecek.<br><br>
